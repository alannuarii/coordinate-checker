...
export default function Home() {
  ...
  return (
    <div class="flex flex-col h-full bg-slate-900 overflow-hidden relative">
      ...
      <div class="flex-1 overflow-y-auto pb-32 flex flex-col relative w-full">
      ...
      <div class="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center">
        {/* Success toast */}
        <div class={`mb-3 bg-green-500/90 text-white text-sm font-semibold px-4 py-2 rounded-full shadow-lg transition-all transform ${saveSuccess() ? 'opacity-100 translate-y-0 visible' : 'opacity-0 translate-y-4 invisible'}`}>
          Coordinate Saved!
        </div>
        ...
        <button
          ...
          class="flex items-center gap-3 bg-blue-600 hover:bg-blue-500 disabled:bg-slate-800 disabled:text-slate-500 disabled:opacity-80 text-white px-7 py-4 rounded-full shadow-[0_0_30px_-5px_var(--color-blue-500)] font-semibold tracking-wide transition-all active:scale-95 border border-blue-400/50"
        >
